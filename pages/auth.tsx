        ...
        <div className="flex justify-center">
          <div className="bg-black bg-opacity-70 px-16 py-16 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full">
            ...
            <div className="flex flex-row items-center gap-2 lg:gap-4 mt-8 justify-center">
              ...
              <div onClick={() => signIn('facebook', { callbackUrl: '/' })} className="w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition">
                <FaFacebook size={32} />
              </div>
              <div onClick={() => signIn('twitch', { callbackUrl: '/' })} className="w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition">
                <FaTwitch size={32} />
              </div>
